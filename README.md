...
- **Next:** Phase 6 — Recovery Candidate (validated treaty + loss event → deterministic calc → reviewable candidate). See [docs/ROADMAP.md](docs/ROADMAP.md).
